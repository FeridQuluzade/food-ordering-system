...
public class OrderDataMapper {
    ...
    public Order createOrderCommandToOrder(CreateOrderCommand createOrderCommand) {
        return Order.builder()
                ...
                .deliveryAddress(orderAddressToStreetAdress(createOrderCommand.getDeliveryAddress()))
    ...
    private List<OrderItem> orderItemsToOrderItemEntites(
    ...
    private StreetAddress orderAddressToStreetAdress(OrderAddress orderAddress) {
